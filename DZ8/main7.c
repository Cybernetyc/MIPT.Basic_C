/*Черкашин Дмитрий. 
Домашнее задание №8. Задача 7. Циклический сдвиг массива вправо на 1.
...
Выход:              10 целых элементов массива через пробел сдвунтых на 1 элементa циклически*/
...
void ArrCycleSlide (int *arr, int n);  // Объявление прототипа функции сдвига массива
...
/* Функция ArrCycleSlide cмещения массива на 1 вправо 
Принимает: 
1)Указатель на массив 
2)Переменную n типа int - длину массива
Ничего не возвращает*/
