...
int main (void)
{
    ...
    for (unsigned i = 0; i < n; i++)
    {
        ...
        /* В переменную summ будем записывать сумму введёных
        элементов массива*/
        summ+=arr[i];
    }

    /* Выведем значение среднего арифметического, согласно условия
    функцией printf. В качестве аргумента передадим значение
    суммы элементов разделённое на их количество*/
    printf("%.3f ",summ/n);
