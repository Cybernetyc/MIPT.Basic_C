/*Черкашин Дмитрий. 
Домашнее задание №10. Задача 1. Три раза. Разбор задачи. 
MFTI_Homeworks DZ10 main1.c
06.04.24
Условие:            В файле .txt дана строка. 
                    Вывести ее в файл .txt три раза через запятую
                    и показать количество символов в ней.

Данные на входе:    Строка из английских букв и пробелов. Не более 100 символов. 
...
int main(void)
{
    ...
    for (int i = 0; i < 3; i++)
    {
        ...
        if (i)
        {
            /* Вывести в файл по указателю fp cтроку*/
            fprintf(fp, ", ");
        }
        /* Вывести в файл по указателю fp массив line как строку*/
        fprintf(fp, "%s", line);
    }
    
    /* В конце вывести в файл по указателю fp счётчик итераций цикла вывода*/
    fprintf(fp, " %d", count);
